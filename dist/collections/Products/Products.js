                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            updated = __assign(__assign({}, data), { stripe_id: createdProduct.id, price_id: createdProduct.default_price });
                            return [2 /*return*/, updated];
                        case 2:
                            if (!(args.operation === "update")) return [3 /*break*/, 4];
                            data = args.data;
                            return [4 /*yield*/, stripe_1.stripe.products.update(data.stripe_id, {
                                    name: data.name,
                        ...
                        case 3:
                            ...
                            updated = __assign(__assign({}, data), { stripe_id: updatedProduct.id, price_id: updatedProduct.default_price });
                            return [2 /*return*/, updated];
